...
[![Go Report Card](https://goreportcard.com/badge/github.com/zoomfoo/wechat-go)](https://goreportcard.com/report/github.com/zoomfoo/wechat-go)
...
## 获取源码
	...
	go get -u -v github.com/zoomfoo/wechat-go
	cd $GOPATH/src/github.com/zoomfoo/wechat-go
	go get ./...
...
在代码中使用配置
```go
import "github.com/zoomfoo/wechat-go/kv"
func demo() {
